...
// Flattened brand mark from components/Logo.tsx, rasterized to a PNG for email
// clients (which strip inline SVG). Regenerate with: npx tsx scripts/gen-email-logo.ts
